    ...
    <div className="h-screen flex justify-center items-center bg-gradient-to-r from-blue-500">
      <div className="hidden sm:block">
        {!err ?(
          ...
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white opacity-20">Wait for to verify your account</h5>
          ...
          <h3 className="mb-2 text-2xl font-bold tracking-tight text-red-900 dark:text-white opacity-20">Error occured,try again later</h3>
        )}
