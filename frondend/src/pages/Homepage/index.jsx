    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row md:ml-20 gap-3">
        ...
        <Selector
          ...
          selected={catagory}
          property={"title"}
          setSelected={handleCatagory}
        />
        {state && catagory && (
          <Button className="bg-red-500 h-12 md:ml-12 w-24 ml-32">
            <Link to={`/search-product/${state}/${catagory}`}>Search</Link>
          </Button>
        )}
      </div>
      <FeaturedProduct />
