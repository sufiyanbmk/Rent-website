...
export const RESET_AUDIO_CALL_QUEUE = 'RESET_AUDIO_CALL_QUEUE';
export const PUSH_TO_AUDIO_CALL_QUEUE = 'PUSHTOAUDIOCALLQUEUE';
export const UPDATE_CALL_DIALOG = 'UPDATE_CALL_DIALOG';
export const TYPING_STATUS = 'TYPING_STATUS';
export const CLEAR = 'CLEAR';
export const CLEAR_RENTED_ITEAM = 'CLEAR_RENTED_ITEAM';
